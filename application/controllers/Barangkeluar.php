...
class Barangkeluar extends CI_Controller
{
    ...
    private function _validasi()
    {
        ...
        $this->form_validation->set_rules('barang_id', 'Sampah', 'required', [
            'required' => 'Sampah harus diisi.'
        ]);
        ...
        [
            ...
            'greater_than' => 'Jumlah Keluar tidak boleh lebih kecil dari atau sama dengan 0.',
            'less_than' => 'Jumlah yang Anda masukkan melebihi jumlah stok yang tersedia.'
        ]
        );
        ...
        $this->form_validation->set_rules(
            ...
            [
                ...
                'greater_than' => 'Harga tidak boleh lebih kecil dari atau sama dengan 0.'
            ]
        );
